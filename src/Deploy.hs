...
import qualified Contracts.SeedPhraseManager (referenceSerialized)
...
data Scripts = Scripts {reference :: String} deriving (Show, Generic, ToJSON)
...
-- -- i added below
-- writeLucidValidatorScript = writeCodeToFile (basePath ++ "plutus-scripts/lucid-seed-phrase.plutus") OnChain.referenceInstancecompileScript